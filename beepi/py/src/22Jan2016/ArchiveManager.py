		...
		if self.keepArchiving:
			...
			if shouldArchiveSound:
				...
				try:
					...
					if self.makeArchive(self.soundDirectoryName, self.soundDirectoryName+'_'+getTimestamp()+'_'+self.piName) == 0:
			...
			if shouldArchivePictures:
				...
				try:
					...
					if self.makeArchive(self.pictureDirectoryName, self.pictureDirectoryName+'_'+getTimestamp()+'_'+self.piName) == 0:
