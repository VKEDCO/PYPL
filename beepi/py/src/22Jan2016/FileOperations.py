...
class FileOperations:
	...
	def makeBackup(self, newFilepath, piName):
		...
		with self.lock:
			os.rename(os.path.join(self.filepath,self.filename), os.path.join(newFilepath,self.filename.split(".")[0] + "_" + getTimestamp() + "_" + piName + ".txt"))
