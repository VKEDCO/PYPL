###################################################################
# module: beepi_convnetgs5_1s.py
#
# description: loading and running ConvNetGS5_1s model.
...
#
# to run:
# python beepi_convnetgs5_1s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs5_1s.py yb.png
# loading ConvNetGS5_1s model...
# ... some tf output
# ConvNetGS5_1s loaded...
# bee_probability    = 1.0
# no_bee_probability = 1.5501295267372688e-24
###################################################################
