###################################################################
# module: beepi_convnet1_1s.py
#
# description: loading and running ConvNet1_1s model.
...
#
# to run:
# python beepi_convnet1_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet1_1s.py yb.png
# loading ConvNet1_1s model...
# ... some tf output
# ConvNet1_1s loaded...
# bee_probability    = 1.0
# no_bee_probability = 3.159895320308182e-16
###################################################################
