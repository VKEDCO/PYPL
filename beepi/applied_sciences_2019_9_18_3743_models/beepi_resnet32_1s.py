###################################################################
# module: beepi_resnet32_1s.py
#
# description: loading and running resnet32_1s model.
...
#
# to run:
# python beepi_resnet32_1s.py <path_to_png_image>
#
# example:
# python beepi_resnet32_1s.py yb.png
# loading ResNet32_1s model...
# ResNet32_1s loaded...
# bee_probability    = 0.9809024333953857
# no_bee_probability = 0.01909753680229187
###################################################################
