###################################################################
# module: beepi_resnet32_2s.py
#
# description: loading and running resnet32_2s model.
...
#
# to run:
# python beepi_resnet32_2s.py <path_to_png_image>
#
# example:
# python beepi_resnet32_2s.py yb.png
# loading ResNet32_2s model...
# ResNet32_2s loaded...
# bee_probability    = 0.9942553639411926
# no_bee_probability = 0.005744636058807373
###################################################################
...
model_name = 'ResNet32_2s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ResNet32(IMWIDTH, IMHEIGHT, IMCHANNEL)
