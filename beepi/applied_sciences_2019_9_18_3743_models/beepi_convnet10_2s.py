###################################################################
# module: beepi_convnet10_2s.py
#
# description: loading and running ConvNet10_2s model.
...
#
# to run:
# python beepi_convnet10_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet10_2s.py yb.png
# loading ConvNet10_2s model...
# ... some tf output
# ConvNet10_2s loaded...
