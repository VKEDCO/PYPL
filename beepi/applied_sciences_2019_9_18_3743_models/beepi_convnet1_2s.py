###################################################################
# module: beepi_convnet1_2s.py
#
# description: loading and running ConvNet1_2s model.
...
#
# to run:
# python beepi_convnet1_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet1_2s.py yb.png
# loading ConvNet1_2s model...
# ... some tf output
# ConvNet1_2s loaded...
# bee_probability    = 0.99998939037323
# no_bee_probability = 1.0658010069164447e-05
###################################################################
...
model_name = 'ConvNet1_2s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet1(IMWIDTH, IMHEIGHT, IMCHANNEL)
