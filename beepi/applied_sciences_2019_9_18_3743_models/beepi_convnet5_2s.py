###################################################################
# module: beepi_convnet5_2s.py
#
# description: loading and running ConvNet5_2s model.
...
#
# to run:
# python beepi_convnet5_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet5_2s.py yb.png
# loading ConvNet5_2s model...
# ... some tf output
# ConvNet5_2s loaded...
# bee_probability    = 0.2742166519165039
# no_bee_probability = 0.7257833480834961
###################################################################
