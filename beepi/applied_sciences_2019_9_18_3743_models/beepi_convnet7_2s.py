###################################################################
# module: beepi_convnet7_2s.py
#
# description: loading and running ConvNet7_2s model.
...
#
# to run:
# python beepi_convnet7_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet7_2s.py yb.png
# loading ConvNet7_2s model...
# ... some tf output
# ConvNet7_2s loaded...
# bee_probability    = 0.0689864307641983
# no_bee_probability = 8.321164386870805e-06
###################################################################
