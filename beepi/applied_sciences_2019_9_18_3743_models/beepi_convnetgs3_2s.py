###################################################################
# module: beepi_convnetgs3_2s.py
#
# description: loading and running ConvNetGS3_2s model.
...
#
# to run:
# python beepi_convnetgs3_2s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs3_2s.py yb.png
# loading ConvNetGS3_2s model...
# ... some tf output
# ConvNetGS3_2s loaded...
# bee_probability    = 1.0
