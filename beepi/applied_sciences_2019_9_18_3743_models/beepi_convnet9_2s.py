###################################################################
# module: beepi_convnet9_2s.py
#
# description: loading and running ConvNet9_2s model.
...
#
# to run:
# python beepi_convnet9_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet9_2s.py yb.png
# loading ConvNet9_2s model...
# ... some tf output
# ConvNet9_2s loaded...
# bee_probability    = 0.9183319807052612
...
model_name = 'ConvNet9_2s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet9(IMWIDTH, IMHEIGHT, IMCHANNEL)
