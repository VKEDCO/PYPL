###################################################################
# module: beepi_convnetgs3_1s.py
#
# description: loading and running ConvNetGS3_1s model.
...
#
# to run:
# python beepi_convnetgs3_1s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs3_1s.py yb.png
# loading ConvNetGS3_1s model...
# ... some tf output
# ConvNetGS3_1s loaded...
# bee_probability    = 1.0
# no_bee_probability = 0.0
###################################################################
...
model_name = 'ConvNetGS3_1s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNetGS3(IMWIDTH, IMHEIGHT, IMCHANNEL)
