###################################################################
# module: beepi_convnetgs2_1s.py
#
# description: loading and running ConvNetGS2_1s model.
...
#
# to run:
# python beepi_convnetgs2_1s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs2_1s.py nb.png
# loading ConvNetGS2_1s model...
# ... some tf output
# ConvNetGS2_1s loaded...
# bee_probability    = 3.269642689929242e-08
# no_bee_probability = 1.0
###################################################################
