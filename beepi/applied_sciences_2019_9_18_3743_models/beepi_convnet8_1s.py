###################################################################
# module: beepi_convnet8_1s.py
#
# description: loading and running ConvNet8_1s model.
...
#
# to run:
# python beepi_convnet8_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet8_1s.py yb.png
# loading ConvNet8_1s model...
# ... some tf output
# ConvNet8_1s loaded...
# bee_probability    = 0.41717466711997986
# no_bee_probability = 0.0010023233480751514
###################################################################
