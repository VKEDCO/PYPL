###################################################################
# module: beepi_vgg16_2s.py
#
# description: loading and running VGG16_2s model.
...
#
# to run:
# python beepi_vgg16_2s.py <path_to_png_image>
#
# example:
# python beepi_vgg16_2s.py yb.png
# loading VGG16_2s model...
# ... some tf output
# VGG16_2s loaded...
