###################################################################
# module: beepi_convnetgs4_1s.py
#
# description: loading and running ConvNetGS4_1s model.
...
#
# to run:
# python beepi_convnetgs4_1s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs4_1s.py nb.png
# loading ConvNetGS4_1s model...
# ... some tf output
# ConvNetGS4_1s loaded...
# bee_probability    = 0.006917654536664486
# no_bee_probability = 0.9930822849273682
###################################################################
...
model_name = 'ConvNetGS4_1s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNetGS4(IMWIDTH, IMHEIGHT, IMCHANNEL)
