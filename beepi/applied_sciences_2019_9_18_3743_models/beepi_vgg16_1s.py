###################################################################
# module: beepi_vgg16_1s.py
#
# description: loading and running VGG16_1s model.
...
#
# to run:
# python beepi_vgg16_1s.py <path_to_png_image>
#
# example:
# python beepi_vgg16_1s.py yb.png
# loading VGG16_1s model...
# ... some tf output
# VGG16_1s loaded...
# bee_probability    = 1.0
...
dnn_model = beepi_convnets.VGG16(IMWIDTH, IMHEIGHT, IMCHANNEL)
