###################################################################
# module: beepi_convnet4_2s.py
#
# description: loading and running ConvNet4_2s model.
...
#
# to run:
# python beepi_convnet4_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet4_2s.py yb.png
# loading ConvNet4_2s model...
# ... some tf output
# ConvNet4_2s loaded...
# bee_probability    = 1.0
...
model_name = 'ConvNet4_2s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet4(IMWIDTH, IMHEIGHT, IMCHANNEL)
