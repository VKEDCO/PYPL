###################################################################
# module: beepi_convnet9_1s.py
#
# description: loading and running ConvNet9_1s model.
...
#
# to run:
# python beepi_convnet9_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet9_1s.py yb.png
# loading ConvNet9_1s model...
# ... some tf output
# ConvNet9_1s loaded...
# bee_probability    = 0.3183404207229614
