###################################################################
# module: beepi_convnet10_1s.py
#
# description: loading and running ConvNet10_1s model.
...
#
# to run:
# python beepi_convnet10_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet10_1s.py yb.png
# loading ConvNet10_1s model...
# ... some tf output
# ConvNet10_1s loaded...
# bee_probability    = 0.551814079284668
# no_bee_probability = 3.1689701245340984e-06
###################################################################
...
model_name = 'ConvNet10_1s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet10(IMWIDTH, IMHEIGHT, IMCHANNEL)
