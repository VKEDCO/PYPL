###################################################################
# module: beepi_convnet8_2s.py
#
# description: loading and running ConvNet8_2s model.
...
#
# to run:
# python beepi_convnet8_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet8_2s.py yb.png
# loading ConvNet8_2s model...
# ... some tf output
# ConvNet8_2s loaded...
# bee_probability    = 0.009439610876142979
# no_bee_probability = 0.000690011540427804
###################################################################
...
model_name = 'ConvNet8_2s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet8(IMWIDTH, IMHEIGHT, IMCHANNEL)
