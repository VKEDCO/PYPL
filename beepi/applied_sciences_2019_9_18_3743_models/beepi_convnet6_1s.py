###################################################################
# module: beepi_convnet6_1s.py
#
# description: loading and running ConvNet6_1s model.
...
#
# to run:
# python beepi_convnet6_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet6_1s.py yb.png
# loading ConvNet6_1s model...
# ... some tf output
# ConvNet6_1s loaded...
# bee_probability    = 0.9972836971282959
# no_bee_probability = 0.0027163077611476183
###################################################################
