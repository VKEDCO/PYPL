###################################################################
# module: beepi_convnetgs2_2s.py
#
# description: loading and running ConvNetGS2_2s model.
...
#
# to run:
# python beepi_convnetgs2_2s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs2_2s.py nb.png
# loading ConvNetGS2_2s model...
# ... some tf output
# ConvNetGS2_2s loaded...
# bee_probability    = 2.8334961825748906e-06
# no_bee_probability = 0.9999971389770508
###################################################################
...
model_name = 'ConvNetGS2_2s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNetGS2(IMWIDTH, IMHEIGHT, IMCHANNEL)
