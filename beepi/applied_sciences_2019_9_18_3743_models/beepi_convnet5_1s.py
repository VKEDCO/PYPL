###################################################################
# module: beepi_convnet5_1s.py
#
# description: loading and running ConvNet5_1s model.
...
#
# to run:
# python beepi_convnet5_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet5_1s.py nb.png
# loading ConvNet5_1s model...
# ... some tf output
# ConvNet5_1s loaded...
# bee_probability    = 0.9945048689842224
# no_bee_probability = 0.005495069082826376
###################################################################
...
model_name = 'ConvNet5_1s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet5(IMWIDTH, IMHEIGHT, IMCHANNEL)
