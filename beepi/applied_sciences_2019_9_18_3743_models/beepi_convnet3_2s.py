###################################################################
# module: beepi_convnet3_2s.py
#
# description: loading and running ConvNet3_2s model.
...
#
# to run:
# python beepi_convnet3_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet3_2s.py nb.png
# loading ConvNet3_2s model...
# ... some tf output
# ConvNet3_2s loaded...
# ConvNet3_2s loaded...
# bee_probability    = 0.000247892108745873
# no_bee_probability = 0.9997521042823792
###################################################################
