###################################################################
# module: beepi_convnetgs1_1s.py
#
# description: loading and running ConvNetGS1_1s model.
...
#
# to run:
# python beepi_convnetgs1_1s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs1_1s.py yb.png
# loading ConvNetGS1_1s model...
# ... some tf output
# ConvNetGS1_1s loaded...
# bee_probability    = 1.0
# no_bee_probability = 1.3982405470646883e-26
###################################################################
