###################################################################
# module: beepi_convnetgs5_2s.py
#
# description: loading and running ConvNetGS5_2s model.
...
#
# to run:
# python beepi_convnetgs5_2s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs5_2s.py yb.png
# loading ConvNetGS5_2s model...
# ... some tf output
# ConvNetGS5_2s loaded...
# bee_probability    = 1.0
# no_bee_probability = 7.451368258423795e-27
###################################################################
...
PERSISTED_DIR = '/home/vladimir/research/GPU/vladimir/persisted_bee2_models/'

tf.reset_default_graph()

model_name = 'ConvNetGS5_2s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNetGS5(IMWIDTH, IMHEIGHT, IMCHANNEL)
