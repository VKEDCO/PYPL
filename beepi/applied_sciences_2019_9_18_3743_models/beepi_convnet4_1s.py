###################################################################
# module: beepi_convnet4_1s.py
#
# description: loading and running ConvNet4_1s model.
...
#
# to run:
# python beepi_convnet4_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet4_1s.py nb.png
# loading ConvNet4_1s model...
# ... some tf output
# ConvNet4_1s loaded...
# bee_probability    = 0.0
