###################################################################
# module: beepi_convnet3_1s.py
#
# description: loading and running ConvNet3_1s model.
...
#
# to run:
# python beepi_convnet3_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet3_1s.py nb.png
# loading ConvNet3_1s model...
# ... some tf output
# ConvNet3_1s loaded...
# bee_probability    = 0.0011794997844845057
# no_bee_probability = 0.9988204836845398
###################################################################
...
model_name = 'ConvNet3_1s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet3(IMWIDTH, IMHEIGHT, IMCHANNEL)
