###################################################################
# module: beepi_convnet2_2s.py
#
# description: loading and running ConvNet2_2s model.
...
#
# to run:
# python beepi_convnet2_2s.py <path_to_png_image>
#
# example:
# python beepi_convnet2_2s.py yb.png
# loading ConvNet2_2s model...
# ... some tf output
# ConvNet2_2s loaded...
# bee_probability    = 0.9457353353500366
# no_bee_probability = 0.05426463857293129
###################################################################
