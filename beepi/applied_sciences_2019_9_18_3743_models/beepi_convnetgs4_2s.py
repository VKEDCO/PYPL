###################################################################
# module: beepi_convnetgs4_2s.py
#
# description: loading and running ConvNetGS4_2s model.
...
#
# to run:
# python beepi_convnetgs4_2s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs4_2s.py yb.png
# loading ConvNetGS4_2s model...
# ... some tf output
# ConvNetGS4_2s loaded...
# bee_probability    = 1.0
# no_bee_probability = 3.261192010883818e-11
###################################################################
