###################################################################
# module: beepi_convnet7_1s.py
#
# description: loading and running ConvNet7_1s model.
...
#
# to run:
# python beepi_convnet7_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet7_1s.py yb.png
# loading ConvNet7_1s model...
# ... some tf output
# ConvNet7_1s loaded...
# bee_probability    = 0.5683366656303406
# no_bee_probability = 3.7041132600279525e-05
###################################################################
...
model_name = 'ConvNet7_1s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet7(IMWIDTH, IMHEIGHT, IMCHANNEL)
