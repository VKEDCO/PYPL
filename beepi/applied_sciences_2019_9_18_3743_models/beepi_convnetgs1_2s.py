###################################################################
# module: beepi_convnetgs1_2s.py
#
# description: loading and running ConvNetGS1_2s model.
...
#
# to run:
# python beepi_convnetgs1_2s.py <path_to_png_image>
#
# example:
# python beepi_convnetgs1_2s.py nb.png
# loading ConvNetGS1_2s model...
# ... some tf output
# ConvNetGS1_2s loaded...
# bee_probability    = 0.0005671375547535717
# no_bee_probability = 0.9994328618049622
###################################################################
...
model_name = 'ConvNetGS1_2s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNetGS1(IMWIDTH, IMHEIGHT, IMCHANNEL)
