###################################################################
# module: beepi_convnet2_1s.py
#
# description: loading and running ConvNet2_1s model.
...
#
# to run:
# python beepi_convnet2_1s.py <path_to_png_image>
#
# example:
# python beepi_convnet2_1s.py yb.png
# loading ConvNet2_1s model...
# ... some tf output
# ConvNet2_1s loaded...
# bee_probability    = 0.999941349029541
# no_bee_probability = 5.859399607288651e-05
###################################################################
...
model_name = 'ConvNet2_1s'
print('loading {} model...'.format(model_name))
dnn_model = beepi_convnets.ConvNet2(IMWIDTH, IMHEIGHT, IMCHANNEL)
